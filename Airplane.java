    ...
    public Airplane(){
        ...
        SEARCHButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(destination.getText().equals("")|| sourceData.getText().equals("")){
                    ...
                    try {
                        String sql = "select * from plane WHERE source= '"+sourceData.getText()+"' AND distenation= '"+destination.getText()+"'";
        ...
        table1.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                int a = Integer.parseInt( dm.getValueAt(selectedRow, 3).toString());
                int b=Integer.parseInt(spinner1.getValue().toString());
                int total=a*b;
